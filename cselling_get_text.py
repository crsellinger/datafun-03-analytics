...
def main():
    ...
    """
    txt_url = "https://raw.githubusercontent.com/curran/data/refs/heads/gh-pages/worldFactbook/GDPPerCapita.txt"
    logger.info("Starting text fetch demonstration...")
    fetch_txt_file(fetched_folder_name, "GDP per Capita.txt", txt_url)
